...
export class IngredientesProductosEntity {
    ...
    @ManyToOne(() => ProductEntity, (producto) => producto.ingredientesProductosEntity)
    @JoinColumn({ name: 'producto_id' })
    producto: ProductEntity

    @ManyToOne(() => IngredientesEntity, (ingredientes) => ingredientes.ingredientesProductosEntity)
